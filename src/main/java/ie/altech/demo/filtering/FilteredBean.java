...
@JsonIgnoreProperties(value={"field_3", "field_5"})
public class FilteredBean {
    ...
    public FilteredBean(String field_1, String field_2, String field_3, String field_4, String field_5, String field_6) {
